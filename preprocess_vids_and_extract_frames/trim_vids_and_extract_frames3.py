...
def process_video(video_path, output_frame_path, base_video_frames, front_adjustment, resize_size, fps=29.97):
...
def trim_and_extract_frames_parallel(input_video_paths, output_frame_paths, front_adjustment_lst, resize_size, music_length, fps=29.97):
    ...
    base_video_frames = int(music_length * fps)
